...
export default function Dashboard() {
  ...
  let correctCounter = localStorage.getItem('correct');
  ...
  return (
    <React.Fragment>
      ...
      <Container maxWidth="sm" component="main" className={classes.heroContent}>
        <Typography component="h1" variant="h2" align="center" style={{color:'red', fontSize:'2em'}} gutterBottom>
          Please choose an option from the navbar.
        </Typography>
        <Typography variant="h5" align="center" color="textSecondary" component="p">
          Games won: {correctCounter}
          <Button color='primary' size='small' onClick={resetResult}>reset</Button>
        </Typography>
      </Container>
      {/* End hero unit */}
